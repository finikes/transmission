...
public class RMIAgentClassCodeBuilder {
	...
	public static String build(Class<?> type, String clientName) {
		...
		sb.append(SystemLineSeparator);
		sb.append("import org.finikes.rmi.client.Client;");
		sb.append(SystemLineSeparator);
		...
		for (Method method : methods) {
			...
			sb.append("		org.finikes.rmi.client.RMI rmi = ").append(interfaceName)
					.append(".class.getAnnotation(org.finikes.rmi.client.RMI.class);");
			sb.append(SystemLineSeparator);
			sb.append("		String url = rmi.url();");
			sb.append(SystemLineSeparator);
			sb.append("		org.finikes.rmi.client.CommunicationMode cMode = rmi.communicationMode();");
			sb.append(SystemLineSeparator);
			sb.append(SystemLineSeparator);
			...
			sb.append(SystemLineSeparator);
			sb.append("			throw new org.finikes.rmi.client.RemoteCommunicateException(e);");
			sb.append(SystemLineSeparator);
			sb.append("		}");
			sb.append(SystemLineSeparator);
			sb.append(SystemLineSeparator);
		...
		sb.append("	private String communicate(org.finikes.rmi.client.CommunicationMode cMode, String url, Map<String, Object> params) {");
		sb.append(SystemLineSeparator);
		sb.append("		String cModeValue = cMode.value();");
		sb.append(SystemLineSeparator);
		sb.append(SystemLineSeparator);
		sb.append("		if(org.finikes.rmi.client.CommunicationMode.HTTP_POST.value().equals(cModeValue)) {");
		sb.append(SystemLineSeparator);
		...
		sb.append(SystemLineSeparator);
		sb.append(SystemLineSeparator);
		sb.append("		if(org.finikes.rmi.client.CommunicationMode.HTTP_GET.value().equals(cModeValue)) {");
		sb.append(SystemLineSeparator);
		...
		sb.append(SystemLineSeparator);
		sb.append(SystemLineSeparator);
		sb.append("		if(org.finikes.rmi.client.CommunicationMode.TCP_RPC.value().equals(cModeValue)) {");
		sb.append(SystemLineSeparator);
		...
		sb.append(SystemLineSeparator);
		sb.append(SystemLineSeparator);
		sb.append("		throw new org.finikes.rmi.client.RemoteCommunicateException(\"Not supported yet : \" + cModeValue);");
		sb.append(SystemLineSeparator);
		sb.append("	}");
		sb.append(SystemLineSeparator);
		sb.append("}");
